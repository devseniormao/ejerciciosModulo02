...
public class TarjetaRegalo extends ProductoFinanciero implements Pago {
    
    private String titular;

    public TarjetaRegalo(int idProducto, double saldo, String tipoProducto, String titular) {
    ...
    public String obtenerDetalles(ArrayList<ProductoFinanciero> productosFinancieros, double monto, int indexProducto) {
        ...
        ((TarjetaRegalo) productosFinancieros.get(indexProducto)).getTitular(),
