...
public class BitCoin extends ProductoFinanciero implements Pago {

    private String titular;


    public BitCoin(int idProducto, double saldo, String tipoProducto, String titular) {
        super(idProducto, saldo, tipoProducto);
        this.titular = titular;
    }

    @Override
    public void procesarPago(ArrayList <ProductoFinanciero> productosFinancieros, double monto, 
    ...
    public String obtenerDetalles(ArrayList <ProductoFinanciero> productosFinancieros, double monto, int indexProducto) {
        ...
        ((BitCoin) productosFinancieros.get(indexProducto)).getTitular(),
        productosFinancieros.get(indexProducto).getIdProducto(), monto,
         productosFinancieros.get(indexProducto).getSaldo());
    }

    @Override
    public boolean validarMonto(ArrayList <ProductoFinanciero> productosFinancieros, double monto, 
    int idProducto, String tipoProducto, String banco) {
